...
length(a[a$months == "Jan" || a$months == "Feb" || a$months == "Mar",])
, "Feb", "Mar")
seasonal_pattern[2,]$NumOfPub <- 
seasonal_pattern[3,]$NumOfPub <- sqldf("SELECT count(*) FROM ArticleFacts WHERE article_date LIKE '%Jul%' OR article_date LIKE '%Aug%' OR article_date LIKE '%Sep%'")
seasonal_pattern[4,]$NumOfPub <- sqldf("SELECT count(*) FROM ArticleFacts WHERE article_date LIKE '% Oct%' OR article_date LIKE '%Nov%' OR article_date LIKE '%Dec%'")
seasonal_pattern
```
