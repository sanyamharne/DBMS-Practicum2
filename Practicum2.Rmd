...
publicationsPerJournal
```

## Part 3: 2. Plotting/Visualizing the analysis
```{r}
barplot(seasonal_pattern$numOfPubs, names.arg = seasonal_pattern$quarter, main = "Seasonal Pattern of Publications per quarter", xlab = "Quarters", ylab = "Nmber of Publications")
```
