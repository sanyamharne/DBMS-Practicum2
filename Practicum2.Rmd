...
journal_id NUMBER,
article_date TEXT,
FOREIGN KEY(article_id) REFERENCES ArticleF1(pmid),
...
```{r}
FactTable1 <- sqldf("SELECT pmid, Journal.journal_id, pub_date FROM Article INNER JOIN Journal ON Article.journal_id = Journal.journal_id")
FactTable1
```
